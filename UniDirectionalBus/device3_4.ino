...
// MAC address for Device 4
uint8_t nextDeviceMac[6] = {0xEC, 0x69, 0xC9, 0x86, 0x61, 0xE8}; // Device 4 MAC
...
void loop() {
    // Device 3 does not start communication; it only passes messages received
}
